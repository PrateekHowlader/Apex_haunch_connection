...
namespace TeklaPH
{
    public class Faces
    {
        ...
        public static List<Face_> Get_faces(Part beam, bool cutflag)
        {
        ...
        public static bool IsLineSegmentIntersectingFace(LineSegment lineSegment, Face face_)
        {
            Line line = new Line();
    ...
    public class Line
    {
        ...
        public static LineSegment ChangeLinesegment(LineSegment segment, double d)
        {
        ...
        public static bool IsPointOnLineSegment(Point point, LineSegment segment)
        {
    ...
    {
        public static bool Display_Prompt(string s )
        {
